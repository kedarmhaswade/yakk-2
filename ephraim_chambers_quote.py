...
Johnson’s dictionary entry also included a quote from Ephraim Chambers, who had stated that the total number of words of length 24 or less, in a 24-letter alphabet, is
1,391,724,288,887,252,999,425,128,493,402,200.

The corresponding number when we replace 24 by 10 in Chambers's statement is 11,111,111,110, and it's only 3905 when we reduce the parameter to 5. Thus, a "combinatorial explosion" certainly
...
def num_max_words(asize=5):
    """
    Returns the maximum number of words of that can be formed by a given alphabet. 
    The minimum word length is 1, and the maximum is `asize`. Repetition of letters is allowed. This is a problem of arrangements.
